...
"""
TARGET直線ロジック採点アプリ
５．１６直線２.csv 実データ列順対応版 + 推奨馬SVG + 買い目表示 + 重賞モード v11_2
...
def create_picks_svg(rec_df: pd.DataFrame) -> str:
    ...
    for _, row in rec_df.iterrows():
        ...
        parts.append(f'<text x="340" y="{y + 154}" fill="{gold}" font-family="{font_family}" font-size="30" font-weight="700">推奨買い方：{bet_summary}</text>')
...
st.caption("v12.2互換CSV + 通常推奨SVG（買い目表示付き）+ 重賞ランキングSVG v11_2")
